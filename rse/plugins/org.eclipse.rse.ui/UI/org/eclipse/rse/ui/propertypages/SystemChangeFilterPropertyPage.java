 ...
 * David McKnight   (IBM)        - [253733] Backport NPE On Promptable Filter's Filter Strings Property Page when Clicking Okay
 ********************************************************************************/
       ...
       implements  ISystemPageCompleteListener, ISystemChangeFilterPaneEditPaneSupplier
{
	...
	protected Control createContentArea(Composite parent)
	{
		...
		{
			changeFilterPane.setEditable(false); // for bug 253733 - we don't verify promptable filters
			int nbrColumns = 1;
