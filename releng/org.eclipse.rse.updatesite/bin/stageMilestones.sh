...
cp ../../signed33Updates/features/*_2.0.1.v* features
cp ../../signed33Updates/features/*_1.0.1.v* features
cp ../../signed33Updates/plugins/*_2.0.1.v* plugins
cp ../../signed33Updates/plugins/*_1.0.1.v* plugins
